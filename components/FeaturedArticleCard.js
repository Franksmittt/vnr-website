...
const FeaturedArticleCard = ({ article }) => (
  <div className="container mx-auto px-4">
    <a href={article.url} className="block group bg-white rounded-2xl shadow-xl overflow-hidden md:grid md:grid-cols-2 hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="p-8 md:p-12 flex flex-col justify-center">
        ...
        <div className="mt-6 flex items-center text-sm">
          <img src={article.author.imageUrl} alt={article.author.name} className="w-10 h-10 rounded-full mr-3" />
          <div>
