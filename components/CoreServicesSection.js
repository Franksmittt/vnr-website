    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <ServiceCard
          ...
          imageAlt="Tax compliance services illustration"
        ...
        <ServiceCard
          ...
          imageAlt="Financial reporting services illustration"
        ...
        <ServiceCard
          image="/images/services/business-valuation.jpg"
          imageAlt="Business valuation services illustration"
        ...
        <ServiceCard
          image="/images/services/secretarial.jpg"
          imageAlt="Company secretarial services illustration"
