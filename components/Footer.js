...
const FooterLink = ({ href, children }) => (
  <li>
    <Link
      href={href}
      // FIX: CONTRAST - Changed text color for better readability
...
const SocialIcon = ({ href, children, label }) => (
  <a
    ...
    // FIX: NAMES & LABELS - Added aria-label for the icon-only link
    aria-label={label}
...
const Footer = () => (
  <footer className="bg-slate-800 text-white">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="space-y-4">
          ...
          {/* FIX: CONTRAST - Changed text color from slate-400 to 300 */}
    ...
    <div className="bg-slate-900 py-4">
       {/* FIX: CONTRAST - Changed text color from slate-500 to 400 */}
