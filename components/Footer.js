...
const LinkedInIcon = ( <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14C2.2 0 0 2.2 0 5v14c0 2.8 2.2 5 5 5h14c2.8 0 5-2.2 5-5V5c0-2.8-2.2-5-5-5zM8 19H5V8h3v11zm-1.5-12.3C5.5 6.7 4.7 5.9 4.7 5S5.5 3.3 6.5 3.3 8.3 4.1 8.3 5 7.5 6.7 6.5 6.7zM21 19h-3v-5.6c0-3.4-4-3.1-4 0V19h-3V8h3v1.8c1.4-2.6 7-2.8 7 2.4V19z" /></svg> );
      ...
      <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="space-y-4">
          ...
          <p className="text-slate-300 text-sm italic">
            “Facilitating sustainable wealth through relevant knowledge and cutting-edge technology.”
          </p>
        ...
        <div>
          <h4 className="font-semibold mb-4 tracking-wider uppercase">Key&nbsp;Services</h4>
          <ul className="space-y-3">
        ...
        <div className="space-y-4 text-sm">
          <h4 className="font-semibold mb-4 tracking-wider uppercase">Get&nbsp;in&nbsp;Touch</h4>
