...
const FooterLink = ({ href, children }) => (
  <li>
    <a
      href={href}
      className="text-slate-400 hover:text-teal-400 transition-colors duration-300 ease-in-out flex items-center text-sm group"
    >
...
const Footer = () => (
  <footer className="bg-slate-800 text-white">
      ...
      <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <SocialIcon href="https://www.linkedin.com/company/vnr/">
              {LinkedInIcon}
            </SocialIcon>
          </div>
        </div>
    ...
    <div className="bg-slate-900 py-4">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
        <p className="mb-2 md:mb-0">
          © {new Date().getFullYear()} VNR (Pty) Ltd. All Rights Reserved.
        </p>
        <div className="flex space-x-6">
          <a href="/paia" className="hover:text-teal-400">
            PAIA Manual
          </a>
